...
// Class to represent a workout with common properties and methods
class Workout {
  date = new Date();
  id = (Date.now() + '').slice(-10); // Generate a unique ID
  clicks = 0; // Number of times the workout has been clicked
  ...
  // Set a description for the workout
  _setDescription() {
    const months = [
      'January',
      'February',
...
// Class for running workouts, extends the Workout class
...
// Class for cycling workouts, extends the Workout class
...
class App {
  ...
  // Load map using user's position
  _loadMap(position) {
  ...
  // Show the form to input workout details
  _showForm(mapE) {
    this.#mapEvent = mapE;
  ...
  //U can use this only in console
  reset() {
